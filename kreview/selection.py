...
- :func:`select_features` — apply hybrid-union selection (top N% by AUC ∪
  top N% by MI) with a zero-variance guard.
"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/03_selection.ipynb.

# %% auto #0
__all__ = ['log', 'score_features', 'select_features']

# %% ../nbs/03_selection.ipynb #core
import numpy as np
import pandas as pd
import structlog
...
def _build_binary_target(
    ...
    Returns:
        (model_df, y) where model_df contains only samples with labels in
        ``_MODEL_LABELS`` and y is 1 for positives, 0 for negatives.
...
def score_features(
    ...
    *,
    ...
    model_df, y = _build_binary_target(matrix_df, label_col)
...
def select_features(
    ...
    *,
    ...
    """Apply hybrid-union feature selection and return a filtered matrix.
    ...
    if "mutual_info" in eval_stats.columns:
        top_by_mi = set(
            eval_stats.nlargest(n_keep, "mutual_info")["feature_column"]
        )
    ...
    model_df, _ = _build_binary_target(matrix_df, label_col)
