...
def single_feature_model(
    ...
    try:
        ...
        results["lr_oof_probs"] = lr_probs.tolist()  # D-01: stored for consistent ROC plots
        ...
        results["rf_oof_probs"] = rf_probs.tolist()  # D-01: stored for consistent ROC plots
        ...
        if XGBClassifier is not None:
            ...
            try:
                ...
                results["xgb_oof_probs"] = xgb_probs.tolist()  # D-01: stored for consistent ROC plots
