...
# %% ../nbs/06_report_data.ipynb #66a13268
...
# %% ../nbs/06_report_data.ipynb #83f26916
...
# %% ../nbs/06_report_data.ipynb #51716aea
...
# %% ../nbs/06_report_data.ipynb #5765928f
...
# %% ../nbs/06_report_data.ipynb #8be19a35
...
# %% ../nbs/06_report_data.ipynb #6967c927
...
# %% ../nbs/06_report_data.ipynb #615aec08
...
# %% ../nbs/06_report_data.ipynb #00ab65b9
...
# %% ../nbs/06_report_data.ipynb #9067aeae
def render_report(
    outdir: str | Path,
    out_html: str | Path,
    *,
    ...
    """Render the single-page report: template + inlined plotly.js + embedded data.

    Fully self-contained output (no CDN): plotly.js comes from the installed
    ``plotly`` python package, so the page works on air-gapped HPC nodes.
    """
